...
UPDATE cities SET recommended_method = 'MWL' WHERE recommended_method = 'TURKEY';

-- JAKIM and KEMENAG (Fajr 20, Isha 18) have identical angles to SINGAPORE
UPDATE cities SET recommended_method = 'SINGAPORE' WHERE recommended_method IN ('JAKIM', 'KEMENAG');

-- Also update any user preferences that reference removed methods
UPDATE user_preferences SET calculation_method = 'MWL' WHERE calculation_method = 'TURKEY';
UPDATE user_preferences SET calculation_method = 'MWL' WHERE calculation_method = 'TEHRAN';
UPDATE user_preferences SET calculation_method = 'SINGAPORE' WHERE calculation_method IN ('JAKIM', 'KEMENAG');
