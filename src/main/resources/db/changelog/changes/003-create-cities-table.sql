...
COMMENT ON TABLE cities IS 'Pre-configured cities with coordinates, timezone, and localized names';
COMMENT ON COLUMN cities.id IS 'URL-safe city identifier (e.g. tashkent, mecca)';
...
COMMENT ON COLUMN cities.latitude IS 'Geographic latitude';
COMMENT ON COLUMN cities.longitude IS 'Geographic longitude';
COMMENT ON COLUMN cities.timezone IS 'IANA timezone identifier';
